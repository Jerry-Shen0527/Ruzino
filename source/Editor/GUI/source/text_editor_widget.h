...
class TextEditor {
   public:
    ...
    void
    MoveLeft(int aAmount = 1, bool aSelect = false, bool aWordMode = false);
    void
    MoveRight(int aAmount = 1, bool aSelect = false, bool aWordMode = false);
   ...
   private:
    ...
    std::string GetText(const Coordinates& aStart, const Coordinates& aEnd)
        const;
