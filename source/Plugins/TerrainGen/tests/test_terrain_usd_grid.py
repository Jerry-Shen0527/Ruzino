...
def test_terrain_grid_3x3():
    ...
    if os.path.exists(output_file):
        ...
        modifier_file = os.path.join(binary_dir, "terrain_grid_3x3_modifiers.usdc")
        ...
        if os.path.exists(modifier_file):
            ...
            assert modifier_size > 50000, f"Modifier file unexpectedly small: {modifier_size} bytes"
        else:
